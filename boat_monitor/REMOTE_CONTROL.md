...
| `boot_ota_max_seconds` | `420` | Max seconds for boot-time OTA; use **420+** on cellular (26-file manifest). On boat power the Pico enforces at least 420s even if this is lower. |
